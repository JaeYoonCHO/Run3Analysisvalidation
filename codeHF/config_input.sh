...
case $INPUT_CASE in
  ...
  16)
   ...
   17)
    ...
    INPUT_IS_O2=1
    INPUT_IS_MC=1
    INPUT_TASK_CONFIG="DOO2_CONV_MCCOLL=1 DOO2_TRCKSEL=1 DOO2_CONV_TRKEX_1_2=1"
    ...
    ;;
   18)
    INPUT_LABEL="Debug on MC validation task - Gen ptl"
    INPUT_DIR="/Users/jaeyooncho/myAnalysis/Run3Analysisvalidation/derivedAO2D/LHC24j6/"
    INPUT_FILES="AO2D.root"
    INPUT_RUN=3
    INPUT_IS_O2=1
    INPUT_IS_MC=1
    INPUT_TASK_CONFIG="DOO2_CONV_MCCOLL=1 DOO2_TRIGSEL=1 DOO2_CONV_TRKEX_1_2=1 DOO2_PID_TPC=1 DOO2_PID_TOF=1 DOO2_HF_PID_CREATOR=1 DOO2_TRCKSEL=1"
    INPUT_PARENT_MASK="/home/alitrain/train-workdir/testdata/LFN/alice/sim/2024/LHC24j6/0/539908/AOD/;/Users/jaeyooncho/myAnalysis/Run3Analysisvalidation/parentAO2D/LHC24j6/"
    ;;
   19)
    INPUT_LABEL="Debug on MC validation task - Gen ptl with LHC24e3 sample"
    INPUT_DIR="/Users/jaeyooncho/myAnalysis/Run3Analysisvalidation/derivedAO2D/"
    INPUT_FILES="AO2D.root"
    INPUT_RUN=3
    INPUT_IS_O2=1
